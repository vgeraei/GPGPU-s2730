...
int main() {
    ...
    float *h_data1_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data2_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data3_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data4_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data5_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data6_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data7_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data8_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data9_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data10_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data11_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    float *h_data12_3 = (float*)malloc(LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    ...
    for (int i = 0; i < LARGE_SIZE * LARGE_ITERATIONS ; ++i) {
    ...
    cudaMalloc(&d_data1_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data2_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data3_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data4_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data5_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data6_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data7_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data8_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data9_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data10_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data11_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    cudaMalloc(&d_data12_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float));
    ...
    cudaMemcpyAsync(d_data1_3, h_data1_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyHostToDevice, stream2);
    cudaMemcpyAsync(d_data3_3, h_data3_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyHostToDevice, stream2);
    cudaMemcpyAsync(d_data5_3, h_data5_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyHostToDevice, stream2);
    cudaMemcpyAsync(d_data7_3, h_data7_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyHostToDevice, stream2);
    cudaMemcpyAsync(d_data9_3, h_data9_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyHostToDevice, stream2);
    cudaMemcpyAsync(d_data11_3, h_data11_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyHostToDevice, stream2);
    ...
    cudaMemcpy(h_data2_3, d_data2_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_data4_3, d_data4_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_data6_3, d_data6_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_data8_3, d_data8_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_data10_3, d_data10_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_data12_3, d_data12_3, LARGE_SIZE * LARGE_ITERATIONS  * sizeof(float), cudaMemcpyDeviceToHost);
